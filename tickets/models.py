...
class Ticket(models.Model):
    ...
    Each ticket contains its own fields and is associated to an user and a particular product which customer license
    has to be active at the time of the creation of the ticket.
    The owner of the ticket needs to be a customer in order for the customer to see it in the "My Tickets" section.
...
class Comment(models.Model):
    ...
    If a ticket is created in the admin panel, a comment associated to it should be created immediately after.
